...
* Deberías haber descargado el paquete de instalación del NFS Plug-in for VAAI (``.vib`) desde el NetApp Support Site. https://mysupport.netapp.com/site/global/dashboard["Soporte de NetApp"^]
