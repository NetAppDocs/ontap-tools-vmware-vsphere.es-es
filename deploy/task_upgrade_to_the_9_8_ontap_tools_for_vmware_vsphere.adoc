...
NOTE: A partir de la actualización de las herramientas ONTAP 9.12, el proceso de autenticación y comunicación de todos los sistemas de almacenamiento cambia de autenticación básica a autenticación basada en certificados mediante la confianza automática en los certificados de almacenamiento de ONTAP .
