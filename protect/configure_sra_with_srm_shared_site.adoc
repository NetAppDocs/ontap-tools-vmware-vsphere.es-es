...
[role="lead"]
ONTAP tools for VMware vSphere admite la configuración de sitio de recuperación compartido de SRM de VMware. Para más información, consulta:  https://techdocs.broadcom.com/us/en/vmware-cis/live-recovery/site-recovery-manager/8-8/site-recovery-manager-installation-and-configuration-8-8.html["Site Recovery Manager en una configuración de sitio de recuperación compartida"^]. Las instancias de Site Recovery Manager Server en el sitio de recuperación se conectan a las mismas instancias de vCenter Server.
...
El artículo de https://kb.netapp.com/mgmt/OTV/SRA/Storage_Replication_Adapter%3A_How_to_configure_SRA_in_a_SRM_Shared_Recovery_Site["Cómo configurar el SRA en un sitio de recuperación compartida de SRM"^] KB detalla el procedimiento para configurar SRA para admitir la configuración de sitio de recuperación compartida de SRM.
