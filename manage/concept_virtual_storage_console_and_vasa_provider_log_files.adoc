...
* `cxf.log`, Que contiene información acerca del tráfico API hacia y desde VASA Provider*`kaminoPrefs.xml`, Que contiene información acerca de la configuración de VSC
